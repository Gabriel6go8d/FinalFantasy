        ...
        <div style={FooStyles}>
            <div className='container'>
                <div className='row justify-content-between align-items-center' style={{height: '100px'}}>
                    <a className='btn default col-12 col-lg-4' href='/'><h3 className='text-white'>FinalFantasy</h3></a>
                    <div className='col-12 col-lg-4'>
                        <div className='row justify-content-around'>                            
                            ...
                            <a className='btn default col-3 ' href='/about'><h5 className='text-white'>About</h5></a>
                        </div>    
                    </div>                
                </div>
            </div>            
